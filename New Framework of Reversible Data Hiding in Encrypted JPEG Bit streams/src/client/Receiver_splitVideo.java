...
public class Receiver_splitVideo extends Frame implements ControllerListener {
     ...
     */
       ...
       {
    	    new Receiver_splitVideo( "D:\\Receiver\\video.mpg");
      }

    public Receiver_splitVideo(String path) {
    ...
    private void imageProfile(VideoFormat vidFormat)
    {
        ...
        System.out.println("name$$$$$$$$$$$$$$$4 "+nn);
         f=new File("D:/Receiver/Frames/"+nn);
